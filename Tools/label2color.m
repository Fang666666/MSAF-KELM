...
switch lower(data_name)
    ...
    case 'dc'
        ...
        case 'new'
        map=[0 255 0;0 0 255;255 255 0;0 255 255; 255 0 255;192 192 192;128 128 128;128 0 0;128 128 0;0 128 0;128 0 128;0 128 128;0 0 128;255 165 0;255 215 0;0 0 0;105 105 105];
        for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(0)
